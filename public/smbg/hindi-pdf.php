...
<section class="content hidden-xs">
    ...
    <div class="row">
        ...
        <a href="pdf/hindi/All_about_Quitting_Smoking_Hindi.pdf">
            <div class="col-lg-4">
        ...
        <a href="pdf/hindi/Leaflet_Gestational_Diabetes_What_to_Expect_hindi.pdf">
            <div class="col-lg-4">
                ...
                <div class="small-box bg-aqua">
                    <center><img src="images/gestational-diabetes.png" style="margin-top: 23px;"></center>
                    <div class="inner">
                        <p align="center" style="color: #494444;">Leaflet-Gestational Diabetes-<br> What to Expect</p>
                    </div>
                </div>
            </div>
        </a>
